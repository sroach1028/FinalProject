...
INSERT INTO `user` (`id`, `first_name`, `last_name`, `username`, `email`, `password`, `enabled`, `role`, `phone`, `address_id`, `image_id`, `bio`) VALUES (6, 'Fred', 'Fredette', 'fredf', 'fredf@gmail.com', '$2a$10$KMIQ9vF8CXH7U2Nqn3wTV.dUq0EzW94gzEvT7yb6rx9fuyFyY6OSS', 1, 'user', '5448900871', 3, NULL, NULL);
INSERT INTO `user` (`id`, `first_name`, `last_name`, `username`, `email`, `password`, `enabled`, `role`, `phone`, `address_id`, `image_id`, `bio`) VALUES (7, 'John', 'Burgers', 'johnb', 'johnb@yahoo.com', '$2a$10$KMIQ9vF8CXH7U2Nqn3wTV.dUq0EzW94gzEvT7yb6rx9fuyFyY6OSS', 1, 'user', '2938747483', 6, NULL, NULL);
INSERT INTO `user` (`id`, `first_name`, `last_name`, `username`, `email`, `password`, `enabled`, `role`, `phone`, `address_id`, `image_id`, `bio`) VALUES (8, 'Caitlin', 'Gerweck', 'caitling', 'caitling@proton.com', '$2a$10$KMIQ9vF8CXH7U2Nqn3wTV.dUq0EzW94gzEvT7yb6rx9fuyFyY6OSS', 1, 'user', '9587756649', 4, NULL, NULL);
INSERT INTO `user` (`id`, `first_name`, `last_name`, `username`, `email`, `password`, `enabled`, `role`, `phone`, `address_id`, `image_id`, `bio`) VALUES (9, 'Pam', 'Gerweck', 'pamg', 'pamg@proton.com', '$2a$10$KMIQ9vF8CXH7U2Nqn3wTV.dUq0EzW94gzEvT7yb6rx9fuyFyY6OSS', 1, 'user', '7203452141', 2, NULL, NULL);
INSERT INTO `user` (`id`, `first_name`, `last_name`, `username`, `email`, `password`, `enabled`, `role`, `phone`, `address_id`, `image_id`, `bio`) VALUES (10, 'Cindy', 'Holcombe', 'cindyh', 'cindyh@icloud.com', '$2a$10$KMIQ9vF8CXH7U2Nqn3wTV.dUq0EzW94gzEvT7yb6rx9fuyFyY6OSS', 1, 'user', '2818553595', 6, NULL, NULL);
...
INSERT INTO `job` (`id`, `skill_id`, `price`, `description`, `title`, `active`, `address_id`, `remote`, `image_url`, `date_created`, `date_updated`, `requestor_id`) VALUES (4, 2, 120.00, 'I need my brakes and oil changed on a 2011 Toyota Tundra. I have the parts.', 'Brakes and oil change.', 1, 2, 0, 'https://gandgautorepair.com/wp-content/uploads/2019/04/horror-4-555x312.jpg', '2019-04-20 16:20:11', '2019-10-10 16:20:11', 7);
...
INSERT INTO `job` (`id`, `skill_id`, `price`, `description`, `title`, `active`, `address_id`, `remote`, `image_url`, `date_created`, `date_updated`, `requestor_id`) VALUES (8, 1, 70.50, 'I\'m having some troubles with my angular front end on a person project. I would appriciate some code review/suggestions.', 'Angular Help', 1, 2, 1, 'https://www.google.com/imgres?imgurl=https%3A%2F%2Fi.udemycdn.com%2Fcourse%2F750x422%2F1247828_32bb.jpg&imgrefurl=https%3A%2F%2Fwww.udemy.com%2Fcourse%2Fthe-complete-angular-master-class%2F&docid=Qddizrce5VZwUM&tbnid=E2pz3WXmzAbIVM%3A&vet=10ahUKEwjv1pSk0czmAhUTZc0KHayKCHIQMwiHASgNMA0..i&w=750&h=422&bih=820&biw=1440&q=angular&ved=0ahUKEwjv1pSk0czmAhUTZc0KHayKCHIQMwiHASgNMA0&iact=mrc&uact=8', '2019-12-23 13:29:46', NULL, 2);
...
INSERT INTO `bid` (`id`, `bid_amount`, `description`, `bidder_id`, `job_id`, `accepted`, `rejected`, `available`) VALUES (3, 60.00, 'I can tutor you for this calculus class. 60$ for 3 hours.', 2, 9, 1, NULL, NULL);
INSERT INTO `bid` (`id`, `bid_amount`, `description`, `bidder_id`, `job_id`, `accepted`, `rejected`, `available`) VALUES (4, 80.00, 'I will construct an expertly composed reasearch paper and I can complete it by this saturday.', 2, 10, 1, NULL, NULL);
INSERT INTO `bid` (`id`, `bid_amount`, `description`, `bidder_id`, `job_id`, `accepted`, `rejected`, `available`) VALUES (5, 100.00, 'I can create a logo for your gig-ity account which will display your skills.', 5, 3, 0, NULL, NULL);
INSERT INTO `bid` (`id`, `bid_amount`, `description`, `bidder_id`, `job_id`, `accepted`, `rejected`, `available`) VALUES (6, 25.00, 'I can come today to cut the grass and plant the tree.', 7, 5, 1, NULL, NULL);
INSERT INTO `bid` (`id`, `bid_amount`, `description`, `bidder_id`, `job_id`, `accepted`, `rejected`, `available`) VALUES (7, 60.00, 'I can come today to cut the grass and plant the tree.', 7, 6, 1, NULL, NULL);
